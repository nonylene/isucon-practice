...
"x86_64-linux-3.10.42-52.145.amzn1.x86_64" or
	die "Errno architecture (x86_64-linux-3.10.42-52.145.amzn1.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
