...
XS_EUPXS(XS_Text__Xslate__Engine_CLONE)
{
    ...
    {
#line 1315 "src/Text-Xslate.xs"
{
    MY_CXT_CLONE;
    tx_my_cxt_init(aTHX_ aMY_CXT_ FALSE);
    PERL_UNUSED_VAR(items);
}
#line 1462 "src/Text-Xslate.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 1326 "src/Text-Xslate.xs"
{
    tx_register_builtin_methods(aTHX_ hv);
}
#line 1495 "src/Text-Xslate.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Text__Xslate__Util_mark_raw)
{
	...
	SV*	str = ST(0)
;
#line 1791 "src/Text-Xslate.xs"
{
    ST(0) = tx_mark_raw(aTHX_ str);
}
#line 2078 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Text__Xslate__Util_unmark_raw)
{
	...
	SV*	str = ST(0)
;
#line 1798 "src/Text-Xslate.xs"
{
    ST(0) = tx_unmark_raw(aTHX_ str);
}
#line 2097 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Text__Xslate__Util_html_escape)
{
	...
	SV*	str = ST(0)
;
#line 1806 "src/Text-Xslate.xs"
{
    ST(0) = tx_html_escape(aTHX_ str);
}
#line 2116 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Text__Xslate__Util_uri_escape)
{
	...
	SV*	str = ST(0)
;
#line 1813 "src/Text-Xslate.xs"
{
    ST(0) = tx_uri_escape(aTHX_ str);
}
#line 2135 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Text__Xslate__Util_is_array_ref)
{
	...
	SV*	sv = ST(0)
;
#line 1820 "src/Text-Xslate.xs"
{
    ST(0) = boolSV( tx_sv_is_array_ref(aTHX_ sv));
}
#line 2154 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Text__Xslate__Util_is_hash_ref)
{
	...
	SV*	sv = ST(0)
;
#line 1827 "src/Text-Xslate.xs"
{
    ST(0) = boolSV( tx_sv_is_hash_ref(aTHX_ sv));
}
#line 2173 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Text__Xslate__Util_is_code_ref)
{
	...
	SV*	sv = ST(0)
;
#line 1834 "src/Text-Xslate.xs"
{
    ST(0) = boolSV( tx_sv_is_code_ref(aTHX_ sv));
}
#line 2192 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
;
	SV*	value = ST(1)
;
#line 1841 "src/Text-Xslate.xs"
{
    ST(0) = tx_merge_hash(aTHX_ NULL, base, value);
}
#line 2213 "src/Text-Xslate.c"
    }
    XSRETURN(1);
}
...
#if XSubPPtmpAAAA
        newXS("Text::Xslate::Engine::CLONE", XS_Text__Xslate__Engine_CLONE, file);
#endif
        newXS("Text::Xslate::Engine::_register_builtin_methods", XS_Text__Xslate__Engine__register_builtin_methods, file);
        newXS("Text::Xslate::Engine::_assemble", XS_Text__Xslate__Engine__assemble, file);
        cv = newXS("Text::Xslate::Engine::render", XS_Text__Xslate__Engine_render, file);
        XSANY.any_i32 = 0;
        cv = newXS("Text::Xslate::Engine::render_string", XS_Text__Xslate__Engine_render, file);
        XSANY.any_i32 = 1;
        newXS("Text::Xslate::Engine::validate", XS_Text__Xslate__Engine_validate, file);
        cv = newXS("Text::Xslate::Engine::current_engine", XS_Text__Xslate__Engine_current_engine, file);
        XSANY.any_i32 = 0;
        cv = newXS("Text::Xslate::Engine::current_file", XS_Text__Xslate__Engine_current_engine, file);
        XSANY.any_i32 = 2;
        cv = newXS("Text::Xslate::Engine::current_line", XS_Text__Xslate__Engine_current_engine, file);
        XSANY.any_i32 = 3;
        cv = newXS("Text::Xslate::Engine::current_vars", XS_Text__Xslate__Engine_current_engine, file);
        XSANY.any_i32 = 1;
        newXS("Text::Xslate::Engine::print", XS_Text__Xslate__Engine_print, file);
        cv = newXS("Text::Xslate::Engine::_die", XS_Text__Xslate__Engine__warn, file);
        XSANY.any_i32 = 1;
        cv = newXS("Text::Xslate::Engine::_warn", XS_Text__Xslate__Engine__warn, file);
        XSANY.any_i32 = 0;
        newXS("Text::Xslate::Util::mark_raw", XS_Text__Xslate__Util_mark_raw, file);
        newXS("Text::Xslate::Util::unmark_raw", XS_Text__Xslate__Util_unmark_raw, file);
        newXS("Text::Xslate::Util::html_escape", XS_Text__Xslate__Util_html_escape, file);
        newXS("Text::Xslate::Util::uri_escape", XS_Text__Xslate__Util_uri_escape, file);
        newXS("Text::Xslate::Util::is_array_ref", XS_Text__Xslate__Util_is_array_ref, file);
        newXS("Text::Xslate::Util::is_hash_ref", XS_Text__Xslate__Util_is_hash_ref, file);
        newXS("Text::Xslate::Util::is_code_ref", XS_Text__Xslate__Util_is_code_ref, file);
        newXS("Text::Xslate::Util::merge_hash", XS_Text__Xslate__Util_merge_hash, file);
        newXS("Text::Xslate::Type::Raw::new", XS_Text__Xslate__Type__Raw_new, file);
        newXS("Text::Xslate::Type::Raw::as_string", XS_Text__Xslate__Type__Raw_as_string, file);
        newXS("Text::Xslate::Type::Macro::as_code_ref", XS_Text__Xslate__Type__Macro_as_code_ref, file);

    /* Initialisation Section */

#line 1298 "src/Text-Xslate.xs"
{
