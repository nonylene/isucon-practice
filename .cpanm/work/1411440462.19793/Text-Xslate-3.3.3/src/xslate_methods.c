...
XS_EUPXS(XS_Text__Xslate__Type__Pair_CLONE)
{
    ...
    {
#line 528 "src/xslate_methods.xs"
{
    MY_CXT_CLONE;
    MY_CXT.pair_stash = gv_stashpvs(TX_PAIR_CLASS, GV_ADDMULTI);
    PERL_UNUSED_VAR(items);
}
#line 681 "src/xslate_methods.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 542 "src/xslate_methods.xs"
{
    ST(0) = *av_fetch(pair, ix, TRUE);
}
#line 715 "src/xslate_methods.c"
    }
    XSRETURN(1);
}
...
#if XSubPPtmpAAAA
        newXS("Text::Xslate::Type::Pair::CLONE", XS_Text__Xslate__Type__Pair_CLONE, file);
#endif
        cv = newXS("Text::Xslate::Type::Pair::key", XS_Text__Xslate__Type__Pair_key, file);
        XSANY.any_i32 = 0;
        cv = newXS("Text::Xslate::Type::Pair::value", XS_Text__Xslate__Type__Pair_key, file);
        XSANY.any_i32 = 1;
    }

    /* Initialisation Section */

#line 518 "src/xslate_methods.xs"
{
    MY_CXT_INIT;
    MY_CXT.pair_stash = gv_stashpvs(TX_PAIR_CLASS, GV_ADDMULTI);
}
