...
#line 618 "xs-src/MouseTypeConstraints.c"
...
#line 760 "xs-src/MouseTypeConstraints.c"
#ifdef USE_ITHREADS
...
XS_EUPXS(XS_Mouse__Util__TypeConstraints_CLONE)
{
    ...
    {
#line 645 "xs-src/MouseTypeConstraints.xs"
{
    MY_CXT_CLONE;
    setup_my_cxt(aTHX_ aMY_CXT);
    PERL_UNUSED_VAR(items);
}
#line 777 "xs-src/MouseTypeConstraints.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Mouse__Util__TypeConstraints__parameterize_ArrayRef_for)
{
	...
	SV*	param = ST(0)
;
#line 664 "xs-src/MouseTypeConstraints.xs"
{
    check_fptr_t fptr;
...
#line 818 "xs-src/MouseTypeConstraints.c"
...
XS_EUPXS(XS_Mouse__Meta__TypeConstraint__identity)
{
	...
	SV*	self = ST(0)
;
#line 741 "xs-src/MouseTypeConstraints.xs"
{
    if(!SvROK(self)) {
...
#line 844 "xs-src/MouseTypeConstraints.c"
...
XS_EUPXS(XS_Mouse__Meta__TypeConstraint_compile_type_constraint)
{
	...
	SV*	self = ST(0)
;
#line 753 "xs-src/MouseTypeConstraints.xs"
{
...
#line 933 "xs-src/MouseTypeConstraints.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV*	sv = ST(1)
;
#line 829 "xs-src/MouseTypeConstraints.xs"
{
...
#line 971 "xs-src/MouseTypeConstraints.c"
	ST(0) = boolSV(RETVAL);
    }
    XSRETURN(1);
}
...
#endif
#if XSubPPtmpAAAA
        newXS("Mouse::Util::TypeConstraints::CLONE", XS_Mouse__Util__TypeConstraints_CLONE, file);
#endif
        cv = newXS("Mouse::Util::TypeConstraints::_parameterize_ArrayRef_for", XS_Mouse__Util__TypeConstraints__parameterize_ArrayRef_for, file);
        XSANY.any_i32 = MOUSE_TC_ARRAY_REF;
        cv = newXS("Mouse::Util::TypeConstraints::_parameterize_HashRef_for", XS_Mouse__Util__TypeConstraints__parameterize_ArrayRef_for, file);
        XSANY.any_i32 = MOUSE_TC_HASH_REF;
        cv = newXS("Mouse::Util::TypeConstraints::_parameterize_Maybe_for", XS_Mouse__Util__TypeConstraints__parameterize_ArrayRef_for, file);
        XSANY.any_i32 = MOUSE_TC_MAYBE;
        newXS("Mouse::Meta::TypeConstraint::_identity", XS_Mouse__Meta__TypeConstraint__identity, file);
        newXS("Mouse::Meta::TypeConstraint::compile_type_constraint", XS_Mouse__Meta__TypeConstraint_compile_type_constraint, file);
        newXS("Mouse::Meta::TypeConstraint::check", XS_Mouse__Meta__TypeConstraint_check, file);

    /* Initialisation Section */

#line 614 "xs-src/MouseTypeConstraints.xs"
{
    MY_CXT_INIT;
    setup_my_cxt(aTHX_ aMY_CXT);
...
#if XSubPPtmpAAAA
#endif
#line 689 "xs-src/MouseTypeConstraints.xs"
...
#line 1089 "xs-src/MouseTypeConstraints.c"
