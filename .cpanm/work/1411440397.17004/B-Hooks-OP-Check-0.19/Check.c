 ...
 * contents of Check.xs. Do not edit this file, edit Check.xs instead.
 *
...
extern "C"
#endif
XS_EXTERNAL(boot_B__Hooks__OP__Check); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_B__Hooks__OP__Check)
{
    dVAR; dXSARGS;
